...
> **Leveln durch Chatten!** 3 XP pro echtem Wort (max 30 XP) + **15 XP für Bilder, Videos & Sprachnachrichten**, 30s Cooldown gegen Spam, Voice 25 XP/Minute, täglicher 5,5%-Schwund um Mitternacht, Leaderboard Top15 **stündlich + bei Level-Ups**, **Level-Belohnungsrollen per Formular** – alles in 10 Sprachen, modernen Components V2 & mit Turso so sparsam wie möglich!
...
| **Leaderboard** | **Stündlich** aktualisiert (Top15 nach Level → XP) **plus bei jedem Level-Up/Down**, aber frühestens alle **10 Minuten** (Throttle). Mit **letzter Aktualisierung + Zeitzone**, Update-Hinweis & **kurzer Schwund-Warnung**. Schlägt das Editieren fehl, wird die alte Nachricht gelöscht und neu gesendet (kein veralteter Zeitstempel bleibt stehen). Marker `xp_leader::v1::` für Self-Healing (Scan jetzt 100 Nachrichten tief). |
