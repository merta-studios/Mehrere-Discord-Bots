...
| **Voice-XP** | **10 XP pro Minute** – einfach dafür, dass man in einem Voice-Channel ist. Egal ob **stumm/taub** (Self-/Server-Mute/Deaf), allein im Channel oder im Stage: **Anwesend = XP**. Keine Sprech-/Pausen-Heuristik mehr. Fair im Vergleich: aktives Chatten bringt bis zu ~60 XP/min, Voice-Präsenz 10 XP/min. |
...
- **Voice-XP kommt nicht?** Einfach in einen Voice-Channel gehen und eine Minute warten (10 XP/min). Nur Bots und nicht konfigurierte Server sind ausgenommen. Der Bot muss nicht im Channel sein.
