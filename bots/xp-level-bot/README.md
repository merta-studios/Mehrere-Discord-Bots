...
| **Bonus-Geschenke** | Läuft der Haupt-Chat heiß (**≥8 Nachrichten von ≥2 Personen in 75 s**), kann mit **25 % Chance** ein Bonus-Container erscheinen: **zufällig 20–40 XP**, „🎁 Einsammeln“-Button – **der erste Klick gewinnt**. Danach bleibt der Button sichtbar, aber **deaktiviert**, und die Nachricht pingt den Gewinner. Ungenutzt verfällt das Geschenk nach **10 Minuten**. Limits: **maximal 4 pro Tag**, **Mindestabstand 1 h 30** (beides restart-fest gespeichert). Ohne Leaderboard-Setup gibt es keine Boni. |
