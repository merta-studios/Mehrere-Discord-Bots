...
> **Leveln durch Chatten!** 3 XP pro echtem Wort (max 30 XP) + **15 XP für Bilder, Videos & Sprachnachrichten**, 30s Cooldown gegen Spam, Voice 25 XP/Minute, täglicher **5%-Schwund um Mitternacht** (wer inaktiv bleibt: **+3 Prozentpunkte je weiterem Inaktiv-Tag** – 5 %, 8 %, 11 % …), Leaderboard Top15 **zuverlässig stündlich + bei Level-Ups**, **geplante Bonus-Geschenke (20–40 XP, 2–4×/Tag) mit „Einsammeln“-Button im Haupt-Chat**, **Level-Belohnungsrollen per Formular** – alles in 10 Sprachen, modernen Components V2 & mit Turso so sparsam wie möglich!
