...
> **Leveln durch Chatten!** 3 XP pro echtem Wort (max 30 XP) + **15 XP für Bilder, Videos & Sprachnachrichten**, 30s Cooldown gegen Spam, Voice 25 XP/Minute, täglicher **10%-Schwund um Mitternacht** (wer inaktiv bleibt: **+5 Prozentpunkte je Inaktiv-Tag** – 10 %, 15 %, 20 % …), Leaderboard Top15 **zuverlässig stündlich + bei Level-Ups**, **zufällige Bonus-Geschenke (20–40 XP) mit „Einsammeln“-Button im Haupt-Chat**, **Level-Belohnungsrollen per Formular** – alles in 10 Sprachen, modernen Components V2 & mit Turso so sparsam wie möglich!
...
| **Bonus-Geschenke** | Läuft der Haupt-Chat heiß (**≥8 Nachrichten von ≥2 Personen in 140 s**), kann mit **25 % Chance** ein Bonus-Container erscheinen: **zufällig 20–40 XP**, „🎁 Einsammeln“-Button – **der erste Klick gewinnt**. Danach bleibt der Button sichtbar, aber **deaktiviert**, und die Nachricht pingt den Gewinner. Ungenutzt verfällt das Geschenk nach **10 Minuten**. Limits: **maximal 4 pro Tag**, **Mindestabstand 1 h 30** (beides restart-fest gespeichert). Ohne Leaderboard-Setup gibt es keine Boni. |
