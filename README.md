...
│   │   ├── index.js
│   │   └── src/              # gesamte Bot-Logik
│   ├── security-bot/         # 🛡️ Sicherheits-Bot (OpenAI Moderation API, Turso-persistiert)
│   │   ├── index.js
