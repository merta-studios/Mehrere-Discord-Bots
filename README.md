...
- **Täglich 0 Uhr** (TZ der Server-Sprache): **-10% Basis** von `needed XP` (je weiterem Inaktiv-Tag +5 Prozentpunkte); bei einem Level-Down wird der echte Restbetrag sauber ins vorige Level übernommen statt pauschal auf `93%` zu springen.
